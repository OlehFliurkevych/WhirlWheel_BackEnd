<%@ include file="/WEB-INF/taglib.jsp" %>
	<c:url var="firstUrl" value="${pageContext.request.contextPath}/news/list/pages/1?field=${sortByField}&sort=${sortDirection}&total=${totalPerPage}" />
	<c:url var="lastUrl" value="${pageContext.request.contextPath}/news/list/pages/${coursesList.totalPages}?field=${sortByField}&sort=${sortDirection}&total=${totalPerPage}" />
	<c:url var="prevUrl" value="${pageContext.request.contextPath}/news/list/pages/${currentIndex - 1}?field=${sortByField}&sort=${sortDirection}&total=${totalPerPage}" />
	<c:url var="nextUrl" value="${pageContext.request.contextPath}/news/list/pages/${currentIndex + 1}?field=${sortByField}&sort=${sortDirection}&total=${totalPerPage}" />
<div class="container-fluid">
        ...
        <div class="container">
            ...
            <c:forEach items="${newsListByPageSize}" var="n">
                 <div class="col-sm-6 col-md-4 news">
                    <a style="color:#2d2d2d;" href="${rootURL}/news/${n.id}/inf">
