...
<div class="container-fluid">
        ...
        <div style="margin-bottom: 20px;" class="container">
            <div class="row">
                <div class="col-sm-8">
                    <img style="border-radius: 10px;" src="img/peugeot_group.jpg" alt="" class="img-responsive">
                </div>
                <div style="padding-top: 20px;" class="col-sm-4">
                    <p style="text-align: center;font-size: 25px;">Peugout</p>
                    <ul>
                        <li>Concern : Peugout motors</li>
        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row" style="padding: 0px 10px;">
                <p style="text-align: center;font-size: 22px;">About <span style="color:#f74d12;"><b>Peugout</b></span></p>
        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row">
                <p style="text-align: center;font-size: 22px;">Some model which belong to <span style="color:#f74d12;"><b>Peugout</b></span></p>
                <hr style="margin-top: 10px;">
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <h3>Do you want to see all model, which belong to Peugout ?</h3>
                    </div>
